...
You must provide a Supabase Postgres `DATABASE_URL` (the backend no longer provisions a local Postgres container).

2) Apply the DB schema to your Supabase database.

- Open Supabase SQL Editor and run: `backend/app/models/local_schema.sql`
